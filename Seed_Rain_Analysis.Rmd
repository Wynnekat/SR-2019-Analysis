...
response <- c(0.677, 0.850, 0.631, 0.886)
lower <- c(0.407, 0.580, 0.361,  0.616)
upper <- c(0.948, 1.120, 0.901, 1.156)
site <- c("TP", "PFCA 1", "PFCA 2", "PFCA 3")
...
response <- c(1112, 4371, 1378, 882)
lower <- c(844, 3320, 1046,  670)
upper <- c(1464, 5756, 1814, 1161)
site <- c("TP", "PFCA 1", "PFCA 2", "PFCA 3")
