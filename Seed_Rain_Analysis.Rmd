...
```{r}
# All species but the ones we don't have weights for

## Eleocharis spp and spp1
## OENFIL
## RUBSPP
...
ggplot(All_Captured_Sum_Lumped, aes(x = Mean_1_Seed_Mass_g*1000, y = Density)) +
  ...
  labs(x = "Seed mass (mg) [log 10 scale]", y = "Seed rain density")+
...
#### More seeds in the youngest restoration 
#### Negative relationship between seed rain density and seed mass 
#### NO differences in the seed rain density and seed mass relationship between sites.
...
ggplot(All_Captured_Biomass, aes(x=Seed_Biomass_g)) + 
...
# Fit a gamma model predicting number of seeds by site
