...
# Get rid of unknown species to make a species list
...
# 0.34554313 0.17437728 0.11238226 0.08203566 0.06245417 0.05093960
...
NMDS_plot <- ggplot(scrs) +
  ...
  annotate("text", x = -.95, y = 1.1, label = "bold(Stress) == 0.174",
  parse = TRUE)+
