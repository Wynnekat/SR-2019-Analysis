...
Seed_Data_Date <-  Seed_Data_Lumped[, -c(7,8)]


# Data set without sampling date (analysis 1 and 3)
Seed_Data_Lumped <- Seed_Data_Lumped[, -c(3,7,8)]
