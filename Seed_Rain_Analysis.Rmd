...
plot(test$weighted_seed_mass*1000~test$Plot)


plot(test2$weighted_seed_mass*1000~test2$Plot)
```
...
ggplot(All_Captured_Sum, aes(x = Mean_1_Seed_Mass_g, y = totseeds, color = Plot)) +
  geom_point()
