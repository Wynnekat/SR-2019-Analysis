...
response.sr <- c(29.9, 35.8, 40.9, 27.2)
lower.sr <- c(26.7, 32.3, 37.1, 24.2)
upper.sr <- c(33.5, 39.5, 45.1, 30.6)
site <- c("TP", "PFCA 1", "PFCA 2", "PFCA 3")
...
response.sr.native <- c(26.9, 28.1, 33.0, 24.1)
lower.sr.native <- c(23.9, 25.0, 29.6, 21.2)
upper.sr.native <- c(30.3, 31.6, 36.8, 27.3)
site <- c("TP", "PFCA 1", "PFCA 2", "PFCA 3")
...
SR.plot.annotated <- SR.plot +  annotate("text", x = 2 , y = 55, label = "*", size = 9.5)+
...
**Figure 4**: The morphospecies richness of seed rain captured per transect in the remnant prairie (dark green) and the young (2-year-old, dark blue), middle-aged (6-7-year-old, light blue), and old (15-year-old, light green) reconstructed prairies between May 31st and December 12th, 2019. Error bars represent 95% confidence intervals around model estimates (black). Asterisk symbols indicate sites that had significantly different amounts of seeds captured when compared to the remnant prairie (p \< 0.05).
...
Native.SR.plot.annotated <- Native.SR.plot +  annotate("text", x = 2 , y = 45, label = "*", size = 9.5)+
  geom_vline(xintercept = 3.5, linetype = "longdash")


```

**Figure 5**: The native morphospecies richness of seed rain captured per transect in the remnant prairie (dark green) and the young (2-year-old, dark blue), middle-aged (6-7-year-old, light blue), and old (15-year-old, light green) reconstructed prairies between May 31st and December 12th, 2019. Error bars represent 95% confidence intervals around model estimates (black). Asterisk symbols indicate sites that had significantly different amounts of seeds captured when compared to the remnant prairie (p \< 0.05).
...
**Figure 6**: Total morphospecies richness of identified seeds for reconstructed and remnant tallgrass prairies during the study period (May 31 to December 12th, 2019).
...
**Figure 7**: Native morphospecies richness of identified seeds for reconstructed and remnant tallgrass prairies during the study period (May 31 to December 12th, 2019).
...
plot_grid(panel_1 , legend, rel_widths = c(3,.5), rel_heights = c(1,1,1.25,1.25, 2))

```


**Results :** Total and native morphospecies richness was only significantly greater in the middle-aged prairie (6-7-year-old prairie) compared to the remnant. Overall, morphospecies richness trended upward during the study period, with more morphospecies captured in the late fall than in the summer.
